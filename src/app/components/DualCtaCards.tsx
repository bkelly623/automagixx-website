...
export default function DualCtaCards({
  ...
  const cardBase = onBlue
    ...
    : "rounded-2xl border border-gray-200/80 bg-white shadow-md shadow-gray-200/50 p-6 sm:p-8 text-center flex flex-col items-center transition hover:shadow-lg hover:-translate-y-0.5";
  ...
  const demoSubCls = onBlue
    ? "text-[11px] text-white/80 tracking-tight mt-1"
    : "text-[11px] text-gray-500 tracking-tight mt-1";
  ...
  return (
    ...
    >
      <div className={cardBase}>
        <p
          className={`text-[13px] font-semibold tracking-tight mb-3 ${onBlue ? "text-white" : "text-blue-600"}`}
        >
          Reach us
        </p>
